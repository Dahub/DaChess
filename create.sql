...
(
	...
	FK_Player_White integer not null constraint fk_player_white foreign key references [chess].[Player] (Id) default 1,
	FK_Player_Black integer not null constraint fk_player_black foreign key references [chess].[Player] (Id) default 2,
